...
class LabsTest extends Component {
    render() {
        return (
                ...
                <div className="usa-grid">
                    <nav id="breadcrumbs">
                        <ul aria-label="Breadcrumb" className="breadcrumb breadcrumb-horizontal">
                            ...
                            <li className="active last breadcrumb-truncate"><Link to="labs-tests">Labs + Tests</Link><span className="divider">/</span></li>
                        </ul>
                    </nav>
                </div>
                        ...
                        <div className="portlet-layout">
                                    ...
                                    <div className="portlet-borderless-container">
                                        <div className="portlet-body">
                                            ...
                                            <ul className="usa-sidenav-list">
                                                ...
                                                <li><Link className="usa-current " to="labs-tests">Labs + Tests</Link>
                                                    <ul className="usa-sidenav-sub_list">
                                                        <li><Link to="self-entered-tests">Self-Entered Tests</Link></li>
                                                        <li><Link to="va-chemistry-hematology">VA Chemistry / Hematology</Link>
                                                        </li>
                                                    </ul>
                                                </li>
                            ...
                            <div className="portlet-column portlet-column-first usa-width-three-fourths usa-layout-docs-main_content" id="column-1">
                                <div className="portlet-dropzone portlet-column-content portlet-column-content-first" id="layout-column_column-1">
                                    <div className="portlet-boundary portlet-boundary_usersegmentcontentdisplay_WAR_contenttargetingweb_ portlet-static portlet-static-end portlet-borderless user-segment-content-display-portlet " id="p_p_id_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_lAD4dc8qUkDd_">
                                        <span id="p_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_lAD4dc8qUkDd" />
                                        <div className="portlet-borderless-container">
                                            <div className="portlet-body">
                                                <div className="content-container ">
                                                    <div className="full-content" id="_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_lAD4dc8qUkDd_FullContent0">
