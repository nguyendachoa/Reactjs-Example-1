...
class accountactivityhistory extends Component {
    render() {
        return (
            ...
            Information</Link><span className="divider">/</span></li>
                            ...
                            <li className="active last breadcrumb-truncate"><Link to="/account-activity-history">Account Activity
            History</Link><span className="divider">/</span></li>
                        </ul>
                    </nav>
                </div>
                <div className="portlets-go-here usa-grid usa-section mhv-padding-top-bottom">
                    <section className="mhv-row-1 usa-grid-full usa-section mhv-padding-top-bottom">
                      ...
                      Password</Link></li>
                                                <li><Link className="usa-current " to="/account-activity-history">Account
                      ...
                      Account Access</Link></li>
                            ...
                            <div className="portlet-column portlet-column-first usa-width-three-fourths usa-layout-docs-main_content" id="column-1">
                                <div className="portlet-dropzone portlet-column-content portlet-column-content-first" id="layout-column_column-1">
                                    <div className="portlet-boundary portlet-boundary_usersegmentcontentdisplay_WAR_contenttargetingweb_ portlet-static portlet-static-end portlet-borderless user-segment-content-display-portlet " id="p_p_id_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_S0EdqtP2yNKs_">
                                        <span id="p_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_S0EdqtP2yNKs" />
                                        <div className="portlet-borderless-container">
                                            <div className="portlet-body">
                                                <div className="content-container ">
                                                    <div className="full-content" id="_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_S0EdqtP2yNKs_FullContent0">
...
export default accountactivityhistory;