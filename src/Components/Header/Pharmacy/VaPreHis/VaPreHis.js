...
class VaPreHis extends Component {
    render() {
        return (
                ...
                <div className="usa-grid">
                    <nav id="breadcrumbs">
                        <ul aria-label="Breadcrumb" className="breadcrumb breadcrumb-horizontal">
                            ...
                            <li className="active last breadcrumb-truncate"><Link to="prescriptions-history">VA Prescription
                                    ...
                                    <div className="portlet-borderless-container">
                                        <div className="portlet-body">
                                            ...
                                            <ul className="usa-sidenav-list">
                                                ...
                                                <li><Link className="usa-current " to="prescriptions-history">VA Prescription
                      History</Link></li>
                      ...
                      + Supplements</Link></li>
                            ...
                            <div className="portlet-column portlet-column-first usa-width-three-fourths usa-layout-docs-main_content" id="column-1">
                                <div className="portlet-dropzone portlet-column-content portlet-column-content-first" id="layout-column_column-1">
                                    <div className="portlet-boundary portlet-boundary_usersegmentcontentdisplay_WAR_contenttargetingweb_ portlet-static portlet-static-end portlet-borderless user-segment-content-display-portlet " id="p_p_id_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_gZZ5OrtTmDiL_">
                                        <span id="p_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_gZZ5OrtTmDiL" />
                                        <div className="portlet-borderless-container">
                                            <div className="portlet-body">
                                                <div className="content-container ">
                                                    <div className="full-content" id="_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_gZZ5OrtTmDiL_FullContent0">
