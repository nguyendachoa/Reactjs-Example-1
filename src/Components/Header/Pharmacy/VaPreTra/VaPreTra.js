...
class VaPreTra extends Component {
    render() {
        return (
                ...
                <div className="usa-grid">
                    <nav id="breadcrumbs">
                        <ul aria-label="Breadcrumb" className="breadcrumb breadcrumb-horizontal">
                            ...
                            <li className="active last breadcrumb-truncate"><Link to="prescription-tracking">VA Prescription
            Tracking</Link><span className="divider">/</span></li>
                        </ul>
                    </nav>
                </div>
                                    ...
                                    <div className="portlet-borderless-container">
                                        <div className="portlet-body">
                                            ...
                                            <ul className="usa-sidenav-list">
                                                ...
                                                <li><Link className="usa-current " to="prescription-tracking">VA Prescription
                      Tracking</Link></li>
                      ...
                      + Supplements</Link></li>
                            ...
                            <div className="portlet-column portlet-column-first usa-width-three-fourths usa-layout-docs-main_content" id="column-1">
                                <div className="portlet-dropzone portlet-column-content portlet-column-content-first" id="layout-column_column-1">
                                    <div className="portlet-boundary portlet-boundary_usersegmentcontentdisplay_WAR_contenttargetingweb_ portlet-static portlet-static-end portlet-borderless user-segment-content-display-portlet " id="p_p_id_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_ROjl8kzoLM0D_">
                                        <span id="p_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_ROjl8kzoLM0D" />
                                        <div className="portlet-borderless-container">
                                            <div className="portlet-body">
                                                <div className="content-container ">
                                                    <div className="full-content" id="_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_ROjl8kzoLM0D_FullContent0">
