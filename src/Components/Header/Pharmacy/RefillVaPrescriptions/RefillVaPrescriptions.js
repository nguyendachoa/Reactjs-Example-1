...
class RefillVaPrescriptions extends Component {
    render() {
        return (
                ...
                <div className="usa-grid">
                    <nav id="breadcrumbs">
                        <ul aria-label="Breadcrumb" className="breadcrumb breadcrumb-horizontal">
                            ...
                            <li className="active last breadcrumb-truncate"><Link to="refill-prescriptions">Refill VA
            Prescriptions</Link><span className="divider">/</span></li>
                        </ul>
                    </nav>
                </div>
                    ...
                    <section className="mhv-row-1 usa-grid-full usa-section mhv-padding-top-bottom">
                                    ...
                                    <div className="portlet-borderless-container">
                                        <div className="portlet-body">
                                            ...
                                            <ul className="usa-sidenav-list">
                                                <li><Link className="usa-current " to="refill-prescriptions">Refill VA
                      Prescriptions</Link></li>
                      ...
                      + Supplements</Link></li>
                          ...
                          confirm any upcoming appointments.</div>
                                    ...
                                    <div className="portlet-boundary portlet-boundary_usersegmentcontentdisplay_WAR_contenttargetingweb_ portlet-static portlet-static-end portlet-borderless user-segment-content-display-portlet " id="p_p_id_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_rlhuQwaBdnRf_">
                                        <span id="p_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_rlhuQwaBdnRf" />
                                        <div className="portlet-borderless-container">
                                            <div className="portlet-body">
                                                <div className="content-container ">
                                                    <div className="full-content" id="_usersegmentcontentdisplay_WAR_contenttargetingweb_INSTANCE_rlhuQwaBdnRf_FullContent0">
...
export default RefillVaPrescriptions;